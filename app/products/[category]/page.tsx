...
// UPDATED: Added Accessories to the valid list
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="w-full lg:w-1/4 h-fit sticky top-28 space-y-8">
            ...
            <div>
               ...
               {loading ? <p className="text-xs text-brand-silver">Loading...</p> : (
                  ...
                  {filteredProducts.map((product) => (
                    <div key={product.id} className="bg-[#1A1A1A] border border-white/5 p-6 flex flex-col group relative">
                        ...
                        <div className="pt-4 border-t border-white/10 mt-auto">
                            <span className="text-white font-bold text-lg mb-3 block">₹{product.price.toLocaleString("en-IN")}</span>
