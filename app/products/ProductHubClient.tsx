              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 text-center">
                 ...
                 <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    {/* FIX: Added aria-hidden="true". 
                       This tells Google: "Do not read this text as part of the link name."
                       Now Google will only see "MEMORY", not "SYSTEM CACHE MEMORY".
                    */}
                    <span 
                        aria-hidden="true" 
                        className="text-brand-white font-bold tracking-[0.3em] text-[10px] uppercase mb-3 block opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-100"
                    >
                        {cat.sub}
                    </span>
